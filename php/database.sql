...
-- Copiando estrutura do banco de dados para LojaWyden
CREATE DATABASE IF NOT EXISTS `LojaWyden` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `mamaezona`;

-- Copiando estrutura para tabela LojaWyden.cliente
...
-- Copiando dados para a tabela LojaWyden.cliente: ~21 rows (aproximadamente)
DELETE FROM `cliente`;
...
-- Copiando estrutura para tabela LojaWyden.cozinha
...
-- Copiando dados para a tabela LojaWyden.cozinha: ~9 rows (aproximadamente)
DELETE FROM `cozinha`;
...
-- Copiando estrutura para tabela LojaWyden.funcionarios
...
-- Copiando dados para a tabela LojaWyden.funcionarios: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela LojaWyden.pedido
...
-- Copiando dados para a tabela LojaWyden.pedido: ~61 rows (aproximadamente)
DELETE FROM `pedido`;
...
-- Copiando estrutura para tabela LojaWyden.produto
...
-- Copiando dados para a tabela LojaWyden.produto: ~26 rows (aproximadamente)
DELETE FROM `produto`;
...
-- Copiando estrutura para tabela LojaWyden.consumo_interno
...
-- Copiando dados para a tabela LojaWyden.consumo_interno: ~2 rows (aproximadamente)
...
-- Copiando estrutura para tabela LojaWyden.contas
...
-- Copiando dados para a tabela LojaWyden.contas: ~1 rows (aproximadamente)
DELETE FROM `contas`;
...
-- Copiando estrutura para tabela LojaWyden.itens_entrada
...
-- Copiando dados para a tabela LojaWyden.itens_entrada: ~16 rows (aproximadamente)
...
-- Copiando estrutura para tabela LojaWyden.itens_vendidos
...
-- Copiando dados para a tabela LojaWyden.itens_vendidos: ~91 rows (aproximadamente)
...
-- Copiando estrutura para procedure LojaWyden.pagamento
DELIMITER //
...
-- Copiando estrutura para procedure LojaWyden.Up_devedores_pagamento
DELIMITER //
...
-- Copiando estrutura para evento LojaWyden.Atualizar_devedores_pagamento
DELIMITER //
...
-- Copiando estrutura para evento LojaWyden.Up_Cliente_Situacao
DELIMITER //
...
-- Copiando estrutura para trigger LojaWyden.Contas_After_Insert
...
-- Copiando estrutura para trigger LojaWyden.cozinha_insert
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Copiando estrutura para view LojaWyden.devedores
...
-- Copiando estrutura para view LojaWyden.pratos_cozinha
-- Removendo tabela temporária e criando a estrutura VIEW final
